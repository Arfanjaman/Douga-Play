...
public class VideoPlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("PlayedVideos");
        initViews();
        playVideo();
        ...
        playerView.setOnTouchListener(new OnSwipeTouchListener(this) {
            @Override
            //this one for swipe brightness and volume
    ...
    private void playVideo() {
        ...
        String title = mVideoFiles.get(position).getTitle();
        saveVideoDetailsToFirebase(path, title);
    ...
    // Save video details to Firebase for the last 10 plays of the user
    private void saveVideoDetailsToFirebase(String path, String title) {
        if (currentUser != null) {
            String userId = currentUser.getUid();
            String videoId = databaseReference.child(userId).push().getKey();
            VideoDetails videoDetails = new VideoDetails(path, title);
            databaseReference.child(userId).child(videoId).setValue(videoDetails);
            ...
            databaseReference.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onCancelled(DatabaseError databaseError) {
                    ...
                    Toast.makeText(VideoPlayerActivity.this, "Error saving video details to Firebase", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
