...
public class FavouriteVideosActivity extends AppCompatActivity {
    ...
    private static final String TAG = "FavouriteVideosActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoFilesAdapter = new VideoFilesAdapter(videoFilesArrayList, this, 0, true);
    ...
    private void fetchRecentVideos() {
        ...
        valueEventListener = new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                swipeRefreshLayout.setRefreshing(false);
                Toast.makeText(FavouriteVideosActivity.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
            }
        };
